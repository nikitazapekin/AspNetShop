        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center;">
            <div>
                ...
                <div style="display: flex; gap: 1rem;">
                    <a href="#products" class="btn" style="background: #28a745; border-color: #28a745;">Каталог удочек</a>
                    <a href="#about" class="btn btn-outline">О компании</a>
                </div>
            </div>
            <div style="text-align: center;">
                <div style="font-size: 8rem; opacity: 0.7;">🎣</div>
                <p style="font-size: 1.1rem; margin-top: 1rem;">Лучшие снасти для вашей рыбалки</p>
            </div>
        </div>
    </div>
</section>